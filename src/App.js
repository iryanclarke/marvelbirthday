  ...
  render() {
    return (
      <div class="datepicker">
        ...
        <div class="column">
          <button onClick>Search for your comic!</button>
        </div>
      </div>
    );
  }
...
class App extends Component {
  ...
  // If Mounted properly
  componentDidMount() {
    axios.get(`https://gateway.marvel.com:443/v1/public/comics?dateRange=${this.props.birthday}&apikey=2be07e16999a2baea0054454ca1a1b3b`)
      .then(res => {
